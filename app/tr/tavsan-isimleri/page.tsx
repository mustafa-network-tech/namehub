...
export const metadata: Metadata = buildMetadata({
  title: "Tavşan İsimleri",
  description: "Yumuşacık dostun için tatlı, sevimli ve eğlenceli tavşan ismi fikirleri.",
  locale: "tr",
});

export default function TavsanIsimleriPage() {
  return (
    <main className="container-page py-8 sm:py-10">
      ...
      <div className="mt-10">
        <InternalPromoBanner seed="rabbit" locale="tr" />
      </div>
    </main>
  );
}
