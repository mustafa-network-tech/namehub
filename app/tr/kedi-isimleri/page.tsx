...
export const metadata: Metadata = buildMetadata({
  title: "Kedi İsimleri",
  description: "Kedin için sevimli, karakterli ve akılda kalıcı isim fikirleri.",
  locale: "tr",
});

export default function KediIsimleriPage() {
  return (
    <main className="container-page py-8 sm:py-10">
      ...
      <div className="mt-10">
        <InternalPromoBanner seed="cat" locale="tr" />
      </div>
    </main>
  );
}
