...
export const metadata: Metadata = buildMetadata({
  title: "Bird Names",
  description: "Cheerful and cute name ideas for parrots, budgies and songbirds.",
  locale: "en",
});

export default function BirdNamesPage() {
  return (
    <main className="container-page py-8 sm:py-10">
      ...
      <div className="mt-10">
        <InternalPromoBanner seed="bird" locale="en" />
      </div>
    </main>
  );
}
