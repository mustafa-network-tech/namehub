...
import { getCategoryStats } from "@/lib/brands";
        ...
        >
          ...
          <div className="flex flex-wrap gap-1.5">
            {c.preview.map((p) => (
              <span
                key={p}
                className="inline-flex items-center rounded-full border border-line/60 bg-white/70 px-2.5 py-0.5 text-xs font-semibold text-ink"
              >
                {p}
              </span>
            ))}
